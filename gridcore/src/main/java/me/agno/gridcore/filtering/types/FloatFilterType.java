...
public final class FloatFilterType<T> extends FilterTypeBase<T, Float> {
    ...
    @Getter
    public Class TargetType = Float.class;
    ...
    public Predicate<T> GetFilterExpression(Function<T, Float> leftExpr, String value, GridFilterType filterType, JinqStream<T> source,
