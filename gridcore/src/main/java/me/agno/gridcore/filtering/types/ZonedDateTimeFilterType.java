...
public class ZonedDateTimeFilterType<T> extends FilterTypeBase<T, ZonedDateTime> {
    ...
    @Getter
    public Class TargetType = ZonedDateTime.class;
    ...
    public Predicate<T> GetFilterExpression(Function<T, ZonedDateTime> leftExpr, String value, GridFilterType filterType, JinqStream<T> source,
