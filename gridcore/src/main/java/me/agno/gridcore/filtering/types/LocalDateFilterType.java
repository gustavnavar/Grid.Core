...
public class LocalDateFilterType<T> extends FilterTypeBase<T, LocalDate> {
    ...
    @Getter
    public Class TargetType = LocalDate.class;
    ...
    public Predicate<T> GetFilterExpression(Function<T, LocalDate> leftExpr, String value, GridFilterType filterType, JinqStream<T> source,
