...
public final class LongFilterType<T> extends FilterTypeBase<T, Long> {
    ...
    @Getter
    public Class TargetType = Long.class;
    ...
    public Predicate<T> GetFilterExpression(Function<T, Long> leftExpr, String value, GridFilterType filterType, JinqStream<T> source,
